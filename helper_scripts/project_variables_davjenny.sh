...
export SINGULARITY_CONTAINER_SCRATCH="${SINGULARITY_SCRATCH_STORAGE_DIR}/difflut.sif"
export SINGULARITY_CONTAINER_PROJECT="${SINGULARITY_PROJECT_STORAGE_DIR}/difflut.sif"
